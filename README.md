...
- [pi使用记录](https://github.com/llj2kh/studynote/wiki/pi使用记录)
- [rsync设置](https://github.com/llj2kh/studynote/wiki/rsync设置)
- [shell编程](https://github.com/llj2kh/studynote/wiki/shell编程)
- [shell命令](https://github.com/llj2kh/studynote/wiki/shell命令)
- [vmware设置](https://github.com/llj2kh/studynote/wiki/vmware设置)
